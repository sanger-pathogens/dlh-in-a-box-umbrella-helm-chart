...
| oauth2-proxy Helm chart | `10.1.4` | MIT | Packaged upstream chart archive. Used to place self-hosted Prefect behind external OIDC authentication in shared environments. The reproduced MIT license text is included at `third_party/oauth2-proxy/LICENSE`. |
