...
| `DLH-C3-VALIDATE-SMOKE` | Smoke Install Workflow | `DLH-C2-VALIDATION` | `.github/workflows/helm-smoke-install.yaml`; `../../scripts/helm/smoke-install.sh` | Installs an identity- and governance-oriented local profile into a disposable cluster to test an integrated runtime path. |
